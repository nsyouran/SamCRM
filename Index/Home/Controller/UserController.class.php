...
class UserController extends CommonController {
    ...
    public function index(){
		...
		$table = M('user');
    	$list = $table->field("user.id,username, tel,group.name as groupname, group.id as groupid,email,user.state,user.last_time")->join("`group` ON user.group=group.id")->select();
		//print_r($list);exit();
