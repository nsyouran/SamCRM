...
<div style="width: 400px; margin: 50px auto; padding : 20px; border: 1px solid #ccc; border-radius: 3px; background: #eee">
    <form action="" method="post" class="form-inline" autocomplete="off">
        ...
        <div class="row" style="margin-bottom: 15px;">
            ...
            <div class="col-sm-10">
                <input id="username" disabled="disabled" name="username" type="text" class="form-control" style="width: 100%" autocomplete="off" value="<?php echo ($list[0]["username"]); ?>">
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 15px;">
            ...
            <div class="col-sm-10">
                <input id="tel" name="tel" type="text" class="form-control" style="width: 100%" autocomplete="off" value="<?php echo ($list[0]["tel"]); ?>">
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 15px;">
            ...
            <div class="col-sm-10">
                <input id="email" name="email" type="text" class="form-control" style="width: 100%" autocomplete="off" value="<?php echo ($list[0]["email"]); ?>">
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 15px;">
            ...
            <div class="col-sm-10">
                <select name="group" id="group" style="width: 100%; height: 34px; border: 1px solid #ccc; border-radius: 4px; font-size: 14px; padding-left:8px;">
                    <?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><option value="<?php echo ($l["id"]); ?>"><?php echo ($l["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        ...
        <div class="row">
            <div class="pull-right" style="padding: 0 20px;">
                ...
                <button class="btn btn-warning" onclick="window.location.href='/SamCRM/index.php/Home/User/user_del?id=<?php echo ($l["id"]); ?>';return false;">删除</button>
