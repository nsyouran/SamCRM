...
<head>
	...
	<script src="/Public/js/jquery.auto_tip.js"></script>
...
<body>
	...
	<div class="nav">
		<ul class="nav nav-tabs">
			...
			<li role="presentation" <?php if($pg == 'task'): ?>class="active"<?php endif; ?>><a href="/index.php/Home/Task/index">任务大厅</a></li>
			<li role="presentation" <?php if($pg == 'mytask'): ?>class="active"<?php endif; ?>><a href="/index.php/Home/Task/mytask">我的任务</a></li>
			...
			<li role="presentation" <?php if($pg == 'help'): ?>class="active"<?php endif; ?>><a href="/index.php/Home/Help/index">HELP</a></li>
			<li role="presentation"><a href="log.html">日志</a></li>
		</ul>
	</div><?php endif; ?>

	C:\fakepath\annotation.xml
