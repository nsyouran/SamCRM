...
<body style="padding: 10px;">
    ...
    <span style="vertical-align: middle; margin: 0 10px;">首页 > 客户管理 > 新增客户</span>
</div>

<div style="width: 650px; margin: 20px auto; padding : 20px; border: 1px solid #aaa; border-radius: 3px; background: #eee">
